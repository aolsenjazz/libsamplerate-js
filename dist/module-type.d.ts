...
export declare type ModuleType = {
     ...
     */
    init(nChannels: number, quality: ConverterTypeValue, inSr: number, outSr: number): void;
    /**
     ...
     */
    simple(length: number, nChannels: number, quality: ConverterTypeValue, inSr: number, outSr: number): number;
    /**
     ...
     */
    full(length: number, nChannels: number, quality: ConverterTypeValue, inSr: number, outSr: number): number;
    /**
